...
var fileDisplayTemplate = '<div class="_jsonform-preview">' +
  ...
  '<% } %>' +
  '</div>' +
  '<a href="#" class="btn btn-default _jsonform-delete"><i class="icon-minus-sign" title="Remove"></i></a> ';
...
jsonform.elementTypes = {
  ...
  'chosen':{
    'template':'<select multiple name="<%= node.name %>" id="<%= id %>"' +
      'class=\'form-control<%= (fieldHtmlClass ? " " + fieldHtmlClass : "") %>\'' +
      '<%= (node.disabled? " disabled" : "")%>' +
      '<%= (node.schemaElement && node.schemaElement.required ? " required=\'required\'" : "") %>' +
      '> ' +
    ...
    'onInsert': function (evt, node) {
      ...
      var setup = function () {
        var formElement = node.formElement || {};
        var item = $(node.el).find('#' + escapeSelector(node.id));
        item.chosen( _.extend( {
   ...
   'logiform':{
    ...
    'onInsert': function (evt, node) {
      ...
      var setup = function () {
        var formElement = node.formElement || {};
        var item = $(node.el).find('#' + escapeSelector(node.id));
        item.logiform( formElement.logiform );
      }
      // Is there a setup hook?
      if ($.fn.logiform) {
        setup();
  ...
  'array': {
    'template': '<div id="<%= id %>"><ul class="_jsonform-array-ul" style="list-style-type:none;"><%= children %></ul>' +
      '<span class="_jsonform-array-buttons">' +
        ...
        /* No needed anymore because there is remove button in every array items */
    ...
    'childTemplate': function (inner) {
	  ...
	  '<a href="#" class="_jsonform-array-item-delete"><i class="glyphicon glyphicon-remove" title="Remove item"></i></a>' +
          inner +
          '</li>';
      }
      else {
    ...
    'onBeforeRender': function (data, node) {
      ...
      _.each(node.children, function (child, idx) {
        ...
        tabs += '<li data-idx="' + idx + '"' +
          ...
          escapeHTML(title) +
	  ' <span href="#" class="_jsonform-array-item-delete"><i class="glyphicon glyphicon-remove" title="Remove item"></i></span>' +
          '</a></li>';
      });
      data.tabs = tabs;
    },
